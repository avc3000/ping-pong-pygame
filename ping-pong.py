...
while run:
    ...
    gad_left_1 = font.render(
        "Gad Left:" + str(left_gadget_remaining), True, WHITE)
    wn.blit(gad_left_1, (25, 65))
    gad_left_2 = font.render(
        "Gad Left:" + str(right_gadget_remaining), True, WHITE)
    ...
    # SECOND PADDLES
    pygame.draw.rect(wn, RED, pygame.Rect(second_left_paddle_x,
                     second_left_paddle_y, paddle_width, paddle_height))
    pygame.draw.rect(wn, RED, pygame.Rect(second_right_paddle_x,
                     second_right_paddle_y, paddle_width, paddle_height))
    ...
    # END SCREEN
    winning_font = pygame.font.SysFont('mono', 70, True)
    if player_1 >= 3:
        wn.fill(BLACK)
